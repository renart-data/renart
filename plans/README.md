...
| [hex-notebook-gap-analysis.md](hex-notebook-gap-analysis.md) | first navigation/focus slice implemented on the feature branch — staged Hex-informed notebook roadmap remains |
