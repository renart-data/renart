...
| [materialization-target-lifecycle.md](materialization-target-lifecycle.md) | investigated — upstream missing-target bootstrap, object-kind replacement, and rename/orphan safety |
