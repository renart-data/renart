...
| [notebook-platform.md](notebook-platform.md) | phases 0–3, native local-agent chat, typed parameters, source promotion, and canvas-first Git-native presentation authoring/runtime/deployment implemented — native Codex chat acceptance plus Claude/OpenCode transport checks pass; remaining client corpus and release hardening remain |
