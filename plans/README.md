...
| --- | --- |
| [Shared preview row loading](preview-row-loading.md) | Inspect/Data Browser replacement loading implemented; notebook generation-safe reads and query/presentation adapters remain |
