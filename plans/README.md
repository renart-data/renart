...
| [notebook-platform.md](notebook-platform.md) | proposal — first-class notebook/presentation artifacts, multi-source execution, statically checked visualizations/filters, and local MCP agents |
