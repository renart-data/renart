...
| [notebook-platform.md](notebook-platform.md) | phases 0–1 + visualization/source/export core + local MCP preview + typed parameters implemented; dashboard/report contracts, lineage, CRUD, and visual/definition authoring now exist — presentation runtime/deployment and release hardening remain |
