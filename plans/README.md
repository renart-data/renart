...
| Doc                                                                                          | Status                                                                                                                                                                       |
| -------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [architecture-maintainability-audit.md](architecture-maintainability-audit.md)               | active follow-up — synchronization hardened; remaining notebook contracts, feature-adjacent ownership, and measured test-cost work                                             |
