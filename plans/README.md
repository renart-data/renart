...
| [cross-pipeline-dependencies.md](cross-pipeline-dependencies.md) | Phase 3 in progress — workspace/manual readiness and immutable deployment dependency manifests ship; scheduled waiting and two-pipeline live coverage remain |
