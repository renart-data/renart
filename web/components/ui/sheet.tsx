    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        onInteractOutside={(event) => {
          if (isPortalledControlInteraction(event)) {
...
const portalledControlSelector = [
...
function isPortalledControlInteraction(event: { target: EventTarget | null }) {
  return event.target instanceof Element && Boolean(event.target.closest(portalledControlSelector));
}
