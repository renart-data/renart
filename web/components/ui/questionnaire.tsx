...
function QuestionnaireChoice({
  ...
  return (
    ...
    >
      ...
      >
        <span className="hidden size-2 rounded-full bg-primary-foreground group-data-[type=checkbox]/questionnaire-choice:hidden group-data-checked/questionnaire-choice:block" />
        <Check className="hidden size-3.5 group-data-[type=radio]/questionnaire-choice:hidden group-data-checked/questionnaire-choice:block" />
      </span>
      ...
      <QuestionnairePrimitive.ChoiceShortcut
        ...
        className="pointer-events-none ms-auto hidden size-4 shrink-0 translate-y-0.5 items-center justify-center rounded-sm border border-input bg-background/80 font-mono text-[0.5625rem] leading-none font-medium text-muted-foreground group-data-[shortcut]/questionnaire-choice:inline-flex"
      />
    </QuestionnairePrimitive.Choice>
  );
}
...
function QuestionnaireInput({
  ...
  return (
    <QuestionnairePrimitive.Input
      ...
      className={cn(
        "min-h-11 w-full min-w-0 rounded-md border border-input bg-input/20 px-3 py-2 text-sm transition-[color,box-shadow,background-color] outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 sm:min-h-8 sm:text-xs",
