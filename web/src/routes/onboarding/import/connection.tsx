...
export const Route = createFileRoute("/onboarding/import/connection")({
  component: OnboardingImportConnectionRouteComponent,
});

function OnboardingImportConnectionRouteComponent() {
